...
public class AbsenceController {
    ...
    public ResponseEntity<ApiResponse<List<AbsenceResponseDto>>> getAbsencesByAgentId(@PathVariable int agentId) {
        return absenceService.getAbsencesByAgentId(agentId);
    }
}
